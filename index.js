...
if (isMobileDevice) {
document.querySelector("body").innerHTML="Sorry for the inconvenience,Currently type tester is only available for Desktops and Laptops"
document.querySelector("body").style.padding="7px"
document.querySelector("body").background="background/error.jpg"
